...
const StudentBulkDeleteDialog = memo(
  ({ open, classroomName, studentCount, isDeleting, onClose, onConfirm }: StudentBulkDeleteDialogProps) => {
    const options: ConfirmDialogOptions = {
      ...
      showWarning: true,
      warningMessage:
        'การดำเนินการนี้ไม่สามารถย้อนกลับได้ ข้อมูลนักเรียนและข้อมูลที่เกี่ยวข้องทั้งหมดจะถูกลบออกจากระบบ',
    };
